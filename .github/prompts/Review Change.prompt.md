...
Use the repository playbook in [AGENTS.md](../../AGENTS.md), the standards in [standards.md](../../docs/ai/standards.md), the commands in [commands.md](../../docs/ai/commands.md), and the reviewer role in [reviewer.md](../../docs/ai/subagents/reviewer.md).
